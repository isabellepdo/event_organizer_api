...
RSpec.describe LecturesController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new lecture" do

        post :create, params: {lecture: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(lecture_url(Lecture.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new lecture" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the lecture" do
        lecture = Lecture.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the lecture" do
        lecture = Lecture.create! valid_attributes
